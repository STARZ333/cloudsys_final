...
def linebot():
    ...
    if message_type == 'text':
        ...
        # Construct image URL
            while(os.path.exists(f'{out_directory}/output.jpg')==False):
                pass
            image_url = f"https://258a-59-125-186-125.ngrok-free.app/{os.path.join(out_directory.lstrip('./'), 'output.jpg')}"
            print(image_url)
